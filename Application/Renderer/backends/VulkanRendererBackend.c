...
static int ev_rendererbackend_loadbasepipelines()
{
  ...
  VkDescriptorSetLayout setLayouts[] = {
    ...
    BASE_DESCRIPTOR_SET_LAYOUTS[EV_DESCRIPTOR_SET_LAYOUT_BUFFER_NOR],
    BASE_DESCRIPTOR_SET_LAYOUTS[EV_DESCRIPTOR_SET_LAYOUT_BUFFER_UV]
  };
...
static int ev_rendererbackend_loadbasedescriptorsetlayouts()
{
...

  {
      ...
      VK_ASSERT(vkCreateDescriptorSetLayout(Vulkan.getDevice(), &descriptorSetLayoutCreateInfo, NULL, &BASE_DESCRIPTOR_SET_LAYOUTS[EV_DESCRIPTOR_SET_LAYOUT_BUFFER_NOR]));
  }
